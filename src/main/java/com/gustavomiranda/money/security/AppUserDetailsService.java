...
import com.gustavomiranda.money.repository.UsuarioRepository;
...
public class AppUserDetailsService implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String email) throws UsernameNotFoundException {
        ...
        Usuario user = usuario.orElseThrow(() -> new UsernameNotFoundException("Usuário e/ou senha incorreto!"));
